...
export class TableWinners {
    ...
    async asyncRenderTable(page, limit) {
        const titleWinnersDOM = document.querySelector('.winners__content--title');
        ...
        this.winnersTableContainerDOM.insertAdjacentHTML('beforeend', `<li class="winners__content--title">
        <h3 >Number</h3>
        <h3>Car</h3>
